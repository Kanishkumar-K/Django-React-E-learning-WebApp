...
const About = () => {
  return (
    ...
    <div style={{ textAlign:"justify", marginLeft:'50px', marginTop:'150px'}}><br/><br/>
       ...
       <Link to="/contacts">
         <button style={{ textAlign:"center",backgroundColor:"#0dd943", color:"black", marginTop:"20px", marginLeft:'700px', paddingTop:'10px', paddingBottom:'10px',paddingLeft:'80px', paddingRight:'70px', padding:"20px", borderRadius:"10px"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Contact Us&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button><br /><br /><br />
       </Link>
